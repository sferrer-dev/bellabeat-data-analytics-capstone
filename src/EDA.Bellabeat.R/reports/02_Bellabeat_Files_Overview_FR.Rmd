...
```{r files_overview_table}

files_overview <- data.frame(
  File = c(
  ...
  `Data type` = c(
    ...
    "Activity intensity",
    "Walking activity",
    "Fine-grained energy expenditure",
    "Activity intensity",
    "Expenditure / effort (METs)",
    "Sleep (stages)",
    "Steps per minute",
    "Weight and BMI"
  ),
  `Key variables` = c(
    "Daily steps, calories, intensity, distance",
    "bpm, timestamp",
    "Calories per hour",
    "Total, light, moderate, very active intensity",
    "Steps per hour",
    "Calories per minute",
    "Intensity per minute",
    "METs",
    "Sleep level, timestamp",
    "Steps per minute",
    "Weight, BMI, is_manual"
  ),
  check.names = FALSE,
